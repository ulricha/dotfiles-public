...
;; TODO
;; integrate flycheck (chrisdone?)
;; integrate auto-complete or company (without ghc)

(setq haskell-au-packages
  '(
    cmm-mode
    company
    company-ghci
...
(defun haskell-au/init-cmm-mode ()
  (use-package cmm-mode
    :defer t))

;; (defun haskell-au/post-init-flycheck ()
...
(defun haskell-au/init-haskell-mode ()
...
(defun haskell-au/init-haskell-snippets ()
...
(when (configuration-layer/layer-usedp 'auto-completion)
  (defun haskell-au/post-init-company ()
    (spacemacs|add-company-hook haskell-mode)
    (spacemacs|add-company-hook haskell-cabal-mode))

  (defun haskell-au/init-company-ghc ()
    (use-package company-ghc
      :if (configuration-layer/package-usedp 'company)
      :defer t
      :init
      (push '(company-ghci company-dabbrev-code company-yasnippet)
            company-backends-haskell-mode))))

;;   (defun haskell-au/init-company-cabal ()
